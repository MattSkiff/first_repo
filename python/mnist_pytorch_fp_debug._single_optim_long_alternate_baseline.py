...
def test(n_test):
  ...
  with torch.no_grad():
    for data, target in test_loader:
      output = network(data)
      test_loss += F.nll_loss(output[0], target, size_average=False).item()
...
plt.ylabel('Loss')
plt.xlabel('Batches')
plt.suptitle(" Train CE Loss vs Epochs",fontsize=14,y=0.975)
...
plt.ylabel('Accuracy')
plt.xlabel('Batches')
plt.suptitle("Train Accuracy vs Epochs",fontsize=14,y=0.975)
plt.title("Classification of MNIST",fontsize=10,y=1)
...
plt.ylabel('Loss')
plt.xlabel('Epochs')
plt.suptitle("Test CE Loss vs Epochs",fontsize=14,y=0.975)
plt.title("Classification of MNIST",fontsize=10,y=1)
...
plt.ylabel('Accuracy')
plt.xlabel('Epochs')
plt.suptitle("Test Accuracy vs Epochs",fontsize=14,y=0.975)
plt.title("Classification of MNIST",fontsize=10,y=1)
